import { isRequired, isValidNumber, isValidString, UrlValidationCheck } from "../../utils/validation.mjs";
...
export const taskRules={
  taskUrl:[
    [(v) => isRequired(v), "Task URL is required"],
    [(v) => UrlValidationCheck(v), "Task URL contains invalid content"],
  ]
}
